...
const ContactList = ({contacts , isChannel = false}) => {
    ...
    // selectedChatData represents the currently selected chat & contact is the new chat that the user clicked on.
    //  It ensures that when the user switches to a different chat, the message history is cleared.
            ...
            <div key={contact._id} className={`pl-10 py-2 transition-all duration-300 cursor-pointer 
                ...
                >
                    <div className="flex gap-5 items-center justify-start text-neutral-300">
                        ...
                        {
                            isChannel && (
                            <div className="h-10 w-10 bg-[#ffffff22] flex items-center justify-center rounded-full">
                                #
                            </div>)
                        }
                        {
